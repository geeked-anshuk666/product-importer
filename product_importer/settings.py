...
if DATABASE_URL:
    ...
    # Check for individual database environment variables that Render might set
    ...
    DB_NAME = os.environ.get('DB_NAME') or os.environ.get('POSTGRES_DATABASE') or os.environ.get('POSTGRES_DB', 'product_importer_db')
